...
class MainWindowSJF(Utils):
    ...
    def sjf(self):
        ...
        # Actualizamos la lista de listos
        ...
        while True:
            ...
            # Escogemos el proceso en cola de listos con el menor Burts_time para ser procesado 
            ...
            # Eliminamos el proceso escogido de la lista de listos
